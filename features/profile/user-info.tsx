...
export const UserInfo = ({
    ...
    return (
        <div className="py-6 px-4 bg-white border-[#E4E4E4] border-[1px] rounded-2xl flex flex-col w-full mt-8">
            <h2 suppressHydrationWarning className="self-center mb-2.5 font-medium text-2xl">
                ...
                {loading ? (
                    ...
                    <>
                        <div className="flex items-start text-sm gap-1">
                            ...
                            <p suppressHydrationWarning className="-mt-[2px]">
            ...
            <div className="flex justify-between">
                ...
                <div className="w-24 flex justify-between">
                    {loading ? (
                        ...
                        <>
                            <div
                                className="size-10 bg-primaryBlocks flex justify-center items-center rounded-xl cursor-pointer">
                                <Image
                                    src="/svg/github.svg"
                                    width={20}
                                    height={20}
