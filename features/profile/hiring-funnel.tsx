...
const ProgressCircle = dynamic(() => import('@/shared/ui/progress-circle').then(mod => mod.ProgressCircle), { ssr: false })
...
export const HiringFunnel = () => {
    ...
    return (
        <div className="py-6 px-4 bg-white border border-[#E4E4E4] rounded-2xl flex flex-col gap-12 w-full lg:h-full">
            <h1 suppressHydrationWarning className="font-medium text-lg sm:text-xl">
