...
import { toggleSidebar } from '@/shared/widgets/models/sidebarSlice'
                        ...
                        <div className="hidden sm:flex gap-5 items-center">
                            ...
                            {user?.profile_picture ? (
                                ...
                                <div
                                    ...
                                    className="size-14 flex cursor-pointer justify-center items-center bg-[#D9D9D9] rounded-full select-none"
                                >
                                    <User size={36} />
                                </div>
                            )}
...
const MobileMenu = ({ open, setOpen }: { open: boolean, setOpen: (value: boolean) => void }) => {
    return <div className="absolute w-screen h-screen bg-white flex flex-col px-6 py-4 z-[100] top-0 sm:hidden">
        <X onClick={() => setOpen(!open)} size={56} className="self-end cursor-pointer select-none" />
